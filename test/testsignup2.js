...
//Sest case 1: check the /santander path, register a user "test" and check the dashboard contents.
async function testcase2(){
    //Launch the firefox browser.
    let driver = await new Builder().forBrowser("firefox").build();

//Step1: open the url in the path /santander.
    try{
        //Open url.
...
//Step11: Find and check for the element: Point of Sale.
        //Wait for the element to be loaded in DOM.
        await driver.wait(until.elementLocated(By.className('welcome-screen-content-button')), 5000);
        //Defines the element identification by html text.
        const PointofSaleDashboardXpathExpression = `//*[contains(text(), '${"Point of Sale"}')]`;
        //Find the input element for field "confirm password".
        await driver.findElement(By.xpath(PointofSaleDashboardXpathExpression));

//Step12: Find and check for the element: Settings.
        //Wait for the element to be loaded in DOM.
        await driver.wait(until.elementLocated(By.className('welcome-screen-content-button')), 5000);
        //Defines the element identification by html text.
